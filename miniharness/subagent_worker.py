...
`python -m miniharness.subagent_worker <acp|sdk> [--permission allow|reject]`
...
from .sdk_protocol import JsonRpcLineTransport, SdkRuntime
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(prog="miniharness.subagent_worker")
