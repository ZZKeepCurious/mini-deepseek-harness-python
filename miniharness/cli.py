...
from .composition import load_composition, load_patch_list, render_composition_dump
...
def _validate_composition(parsed: dict[str, Any]) -> None:
    ...
    from .composition import resolve_js_exprs
...
def _main(args: list[str]) -> None:
    if args and args[0] == "sessions":
        from .sessions import sessions_main
